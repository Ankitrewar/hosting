//navgation bar effect on scroll
...
portfolioCloseBtns.forEach((portfolioCloseBtn) => {
    portfolioCloseBtn.addEventListener("click", () => {
        portfolioModal.forEach((portfolioModalView) => {
...
//target element and soacify option to create reveal animation

ScrollReveal().reveal('.home .info h2, .section-title-01, .section-title-02', { delay: 500, origin: 'left'});
ScrollReveal().reveal('.home .info h3, .home .info p, .about-info p, .btn', { delay: 600, origin: 'right'});
ScrollReveal().reveal('.home .info .btn',{ delay: 700, origin: 'bottom'});
ScrollReveal().reveal('.media-icons i, .contact-left li',{ delay: 500, origin: 'left', interval: 200});
ScrollReveal().reveal('.home-img, .about-img',{ delay: 500, origin: 'bottom',});
ScrollReveal().reveal('.about, .description, .contact-right',{ delay: 500, origin: 'bottom',});
ScrollReveal().reveal('.about .professional-list li, .list-item',{ delay: 500, origin: 'right', interval:200});
